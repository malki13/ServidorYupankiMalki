...
a persistence unit "ServidorYupankiMalkiPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ServidorYupankiMalki\pom.xml":
...
artifact ("ServidorYupankiMalki.war") is already built. You can build
